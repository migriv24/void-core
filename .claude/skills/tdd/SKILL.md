...
When exploring the codebase, read the project's knowledge bundle if it exists — an **OKF bundle** (e.g. `okf/`) or a `CONTEXT.md` — so test names and interface vocabulary match the project's domain language, and respect any recorded decisions (ADRs / the OKF log) in the area you're touching.
