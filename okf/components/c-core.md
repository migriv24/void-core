...
The current implementation of Void Core: ~2600 lines of hand-written C over vendored
...
`current`. C smoke + Python smoke both green (built 2026-06-15). Deferred (research,
not gaps): the [interaction-net](/concepts/interaction-nets.md) reducer, glyph host
callbacks over FFI, advanced Voidscript. Design: [C core with FFI bindings](/design/c-core-architecture.md).
